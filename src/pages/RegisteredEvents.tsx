...
const RegisteredEvents: React.FC = () => {
  ...
  const formatRetention = (retention: string) => {
    // Converter formato "168h0m0s" para algo mais legível
      ...
      <div className="min-h-screen bg-gray-900 text-white p-6">
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <p className="text-gray-400">Carregando eventos registrados...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="bg-gray-800 rounded-lg p-6 mb-6">
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1">
            <input
              type="text"
              placeholder="Buscar por nome, serviço ou team..."
              value={searchTerm}
          ...
          <div className="bg-gray-800 rounded-lg max-w-4xl w-full max-h-[80vh] overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b border-gray-700">
              <h3 className="text-lg font-semibold">
                JSON do Evento: {selectedEvent.name}
              </h3>
              <button
